    ...
    <section className="py-24 px-4 sm:px-6 lg:px-8 bg-white" id="pricing">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          {/* Free */}
          <div className="relative rounded-2xl border-2 border-indigo-500 bg-indigo-50/30 p-8 flex flex-col">
          ...
          <div className="relative rounded-2xl border-2 border-slate-200 bg-white p-8 flex flex-col">
            ...
            <button className="w-full py-3 border border-slate-300 text-slate-600 font-semibold rounded-lg hover:bg-slate-50 transition-colors">
              Join waitlist
            </button>
          </div>
        </div>
