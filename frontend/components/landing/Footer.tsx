        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12">
          ...
          <div className="space-y-4">
            <div className="flex items-center gap-2">
              <svg className="h-7 w-7 text-indigo-400" fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewBox="0 0 24 24">
                <path d="M12 2l8.66 5v10L12 22l-8.66-5V7L12 2z" />
              </svg>
              <span className="text-white font-semibold text-lg">Archflow</span>
            </div>
            <p className="text-sm leading-relaxed">Visual system architecture for engineers.</p>
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm">
              ...
              <li><a href="mailto:hello@archflow.app" className="hover:text-white transition-colors">hello@archflow.app</a></li>
            </ul>
          </div>
        </div>
      </div>
