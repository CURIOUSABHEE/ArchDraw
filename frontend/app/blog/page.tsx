  ...
  return (
    <div className="min-h-screen flex items-center justify-center" style={{ backgroundColor: '#080c14' }}>
      <div className="text-center max-w-md mx-auto px-6">
        <div className="mb-8">
<div className="inline-flex items-center justify-center w-16 h-16 rounded-2xl mb-6" style={{ backgroundColor: 'rgba(89,89,89,0.1)', border: '1px solid rgba(89,89,89,0.2)' }}>
             <svg className="w-8 h-8" style={{ color: '#595959' }} fill="none" stroke="currentColor" strokeWidth="1.5" viewBox="0 0 24 24">
        ...
        <Link
          ...
          style={{ backgroundColor: '#595959', boxShadow: '0 4px 20px rgba(89,89,89,0.3)' }}
        >
